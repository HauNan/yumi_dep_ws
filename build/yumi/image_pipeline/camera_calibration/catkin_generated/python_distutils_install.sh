...
echo_and_run cd "/home/houlam/yumi_depends_ws/src/yumi/image_pipeline/camera_calibration"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/houlam/yumi_depends_ws/build/yumi/image_pipeline/camera_calibration \
    build --build-base "/home/houlam/yumi_depends_ws/build/yumi/image_pipeline/camera_calibration" \
    install \
    --root="${DESTDIR-/}" \
