...
echo_and_run cd "/home/houlam/yumi_depends_ws/src/yumi/tensorflow_object_detector"
...
echo_and_run /usr/bin/env \
    ...
    "/home/houlam/yumi_depends_ws/src/yumi/tensorflow_object_detector/setup.py" \
     \
    build --build-base "/home/houlam/yumi_depends_ws/build/yumi/tensorflow_object_detector" \
    install \
    --root="${DESTDIR-/}" \
