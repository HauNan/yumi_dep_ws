...
get_filename_component(_filename "/home/houlam/yumi_depends_ws/src/yumi/yumi_hw/srv/YumiGrasp.srv" NAME_WE)
add_custom_target(_yumi_hw_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "yumi_hw" "/home/houlam/yumi_depends_ws/src/yumi/yumi_hw/srv/YumiGrasp.srv" ""
)
...
_generate_srv_cpp(yumi_hw
  "/home/houlam/yumi_depends_ws/src/yumi/yumi_hw/srv/YumiGrasp.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/yumi_hw)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/yumi_hw\")")
  # install generated code
  install(
