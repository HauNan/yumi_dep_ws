...
if("TRUE" STREQUAL "TRUE")
  set(realsense2_description_SOURCE_PREFIX /home/houlam/yumi_depends_ws/src/yumi/realsense2_description)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense2_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/houlam/yumi_depends_ws/src/yumi/realsense2_description/${idir}'.  ${_report}")
    endif()
