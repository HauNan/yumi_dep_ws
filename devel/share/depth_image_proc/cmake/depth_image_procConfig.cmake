...
if("TRUE" STREQUAL "TRUE")
  set(depth_image_proc_SOURCE_PREFIX /home/houlam/yumi_depends_ws/src/yumi/image_pipeline/depth_image_proc)
  set(depth_image_proc_DEVEL_PREFIX /home/houlam/yumi_depends_ws/devel)
  ...
  set(depth_image_proc_INSTALL_PREFIX /home/houlam/yumi_depends_ws/install)
...
if(NOT "/home/houlam/yumi_depends_ws/src/yumi/image_pipeline/depth_image_proc/include " STREQUAL " ")
  set(depth_image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/houlam/yumi_depends_ws/src/yumi/image_pipeline/depth_image_proc/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'depth_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/houlam/yumi_depends_ws/src/yumi/image_pipeline/depth_image_proc/${idir}'.  ${_report}")
    endif()
