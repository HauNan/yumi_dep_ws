...
if("TRUE" STREQUAL "TRUE")
  set(yumi_test_controllers_SOURCE_PREFIX /home/houlam/yumi_depends_ws/src/yumi/yumi_test_controllers)
  set(yumi_test_controllers_DEVEL_PREFIX /home/houlam/yumi_depends_ws/devel)
  ...
  set(yumi_test_controllers_INSTALL_PREFIX /home/houlam/yumi_depends_ws/install)
...
if(NOT "/home/houlam/yumi_depends_ws/src/yumi/yumi_test_controllers/include " STREQUAL " ")
  set(yumi_test_controllers_INCLUDE_DIRS "")
  set(_include_dirs "/home/houlam/yumi_depends_ws/src/yumi/yumi_test_controllers/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'yumi_test_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/houlam/yumi_depends_ws/src/yumi/yumi_test_controllers/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT yumi_test_controllers_NUM_DUMMY_TARGETS)
      set(yumi_test_controllers_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::yumi_test_controllers::wrapped-linker-option${yumi_test_controllers_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR yumi_test_controllers_NUM_DUMMY_TARGETS "${yumi_test_controllers_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::yumi_test_controllers::wrapped-linker-option${yumi_test_controllers_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND yumi_test_controllers_LIBRARIES "${interface_target_name}")
